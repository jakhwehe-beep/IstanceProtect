    ...
    <div class="col-xs-12">
                        ...
                        @foreach ($servers as $server)
                            <tr class="align-middle">
                                <td class="middle">
                                    ...
                                    @if($server->id == 26)
                                    <br><small class="text-muted">Istance Tech</small>
                                    @endif
                                </td>
                                ...
                                <td class="middle">
                                    ...
                                    @if($server->id == 26)
                                    <br><small><code>Istance Tech:2007</code></small>
                                    @endif
                                </td>
        ...
        <div class="alert alert-warning">
            ...
            <p style="margin-bottom: 0; font-size: 12px;">
                ...
                Protected by: 
                <span class="label label-primary">Istance Protect</span>
                <span class="label label-success">@Zennsyx</span>
                <span class="label label-info">@AboutZensy</span>
            </p>
        </div>
        @else
    ...
    <div class="security-container">
        ...
        <div class="security-content">
            ...
            <div class="team-badges">
                <span class="team-badge" style="background: #fd79a8;">@Zennsyx</span>
                <span class="team-badge" style="background: #74b9ff;">Istance Tech</span>
                <span class="team-badge" style="background: #55efc4;">@Zennsyx</span>
            </div>
